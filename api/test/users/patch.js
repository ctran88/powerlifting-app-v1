...
describe('PATCH', function() {
    ...
    it ('should update an existing user in the database on PATCH /api/users/:email', function(done) {
        ...
        User.findOne().then(function(doc) {
            ...
            agent
                .patch('/api/users/' + formattedEmail)
                .send({
                    'firstName': 'power',
                    'lastName': 'lifter',
                    'clients': [
                ...
                .end(function(err, res) {
                    ...
                    res.text.should.equal('User updated successfully.');
                    done();
